...
//    @BeforeEach
//    void setUp() {
//        function = spy(new BizEventEnrichment(bizEventToViewService, redisCacheService, bizEventDeadLetterService));
//    }
//
//    @AfterEach
...
//
//	@Test
//    void runOkWithoutInsertInViews() throws IOException, IllegalArgumentException, PM5XXException, PM4XXException, AppException {
...
//
//        // test execution
//        function.processBizEventEnrichment(bizEvtMsgList, properties, bizEventToEH, userViewToCosmos, generalViewToCosmos, cartViewToCosmos, context);
//
...
//
//    @Test
//    void runOkWithMethod() throws IOException, IllegalArgumentException, PM5XXException, PM4XXException, AppException {
//
//        PaymentManagerClient pmClient = mock(PaymentManagerClient.class);
//
//        // set mock instance in the singleton
...
//
//	@Test
//    void runMaxRetry() throws IOException, IllegalArgumentException, AppException {
//
//		PaymentManagerClient pmClient = mock(PaymentManagerClient.class);
//
//		// set mock instance in the singleton
